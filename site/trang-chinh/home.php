...
<div class="container bg-3 text-center">    
    ...
    ?>
        <div class="col-sm-2 border border-secondary py-3 mx-3 ">
            <img class="card-img-top" src="<?=$CONTENT_URL?>/img/<?php echo $item['hinh'] ?>" alt="Card image" style="width:50%; height:50%;">
            <div class="card-body">
                <h6 class="card-title"><a href="<?=$SITE_URL?>/sanpham/index.php?chi-tiet&ma_hh=<?php echo $item['ma_hh'] ?>" class="text-black"><?php echo $item['ten_hh'] ?></a></h6>
